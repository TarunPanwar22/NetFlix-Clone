...
const apiPaths = {
    ...
    searchOnYoutube:  (query) => `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyBHUtOeVrXZzP6HROq1XToaoiGEeqM72e4`,
...
function buildBannerSection(movie){
    ...
    div.innerHTML = `
            <h2 class="banner_title">${movie.name}</h2>
            <p class="banner_info">Trending in movies | Released - ${movie.first_air_date}</p>
